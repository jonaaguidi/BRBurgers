      ...
      <div className="hero-content">
        ...
        <div className="hero-buttons">
          ...
          <button className="btn-wsp">
            <Link to="https://web.whatsapp.com/send?phone=5491122529712&text=Holaa,%20%C2%BFC%C3%B3mo%20va?%20Somos%20BR-BURGERS,%20Escribe%20tu%20Pedido%20o%20Consulta%20aqu%C3%AD...%0A%C2%A1Gracias!" target="_blank" rel="noreferrer">
              CONTACTO
            </Link>
          </button>
        </div>
